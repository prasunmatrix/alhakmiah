    ...
    public function saveContact(Request $request)
    {
        ...
        try {
            ...
            if ($validator->fails()) { 
                ...
                $sAccessToken = '1000.a67541a07a3e8c45817c3d5cc1084ab1.ec8b3e61327e89416606b5067319e78a'; // change me
    ...
    public function saveContactAr(Request $request)
    {
        ...
        try {
            ...
            if ($validator->fails()) { 
                ...
                $sAccessToken = '1000.3d026da68ed3ba9e72b49578fb6bef02.322d16a28f402954d523356048a34e8f'; // change me
                $sJSON = json_encode(array(
                    'First_Name' => $fullName,
                    'Last_Name' => '',
                    'Email' => $request->emailid,
