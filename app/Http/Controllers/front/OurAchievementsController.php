...
class OurAchievementsController extends Controller
{
	...
	public function index()
	{
      ...
      return view('front/en/our-achievement/achievement',$data);
    ...
    {  
        ...
        $data['switch_lang'] = 'EN';
        $data['switch_link'] = 'en/our-achievements';
        $data['ourAchievements'] =OurAchievement::where(['status'=>'A'])
                                                                        ->whereNull('deleted_at')
                                                                        ->orderBy('id','desc')
                                                                        //->paginate(self::$paginationLimit);
        ...
        $data['ourAchievementsHeading']= PageTitle::first();
        // echo "<pre>";
        // print_r($data['ourAchievementsHeading']); die;
      ...
      return view('front/ar/our-achievement/achievement_arabic',$data);
