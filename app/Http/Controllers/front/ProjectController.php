    ...
    public function saveContact(Request $request)
    {
        ...
        try {
            ...
            if ($validator->fails()) { 
                ...
                // lead genreate through api start date: 25/feb/2022
                error_reporting(E_ALL);
                ini_set('display_errors','On');
                header('Content-Type: text/plain');
                
                $sAccessToken = '1000.0f0dec778dcc6a2a8ca083b8feb32906.e465e941e0805de1734dff2c386ad92a'; // change me
                $sJSON = json_encode(array(
                    ...
                    'Lead_Source' => $request->project_name
                  ));
                ...
                session()->flash('success', 'Welcome ... Your request has been successfully sent and the sales team will contact you soon');
            ...
            //session()->flash('error', 'Your email sending is exceed');
    ...
    public function saveContactAr(Request $request)
    {
        ...
        try {
            ...
            $message = [
                    ...
                    'first_name.required' => 'االاسم مطلوب',
                    'last_name.required'  => 'الأسرة مطلوبة',
            ...
            if ($validator->fails()) { 
                ...
                session()->flash('success', 'حياك الله ... تم إرسال طلبك بنجاح وسيتواصل معك فريق المبيعات في أقرب وقت');
                Session::flash('alert-class', 'alert-success'); 
                return redirect('project-detail/'.$_POST['slug'].'/#pcontact');
            ...
            //session()->flash('error', $e->getMessage());
            session()->flash('error', '.إرسال البريد الإلكتروني الخاص بك يتجاوز');
            Session::flash('alert-class', 'alert-danger');
            return redirect('project-detail/'.$_POST['slug'].'/#pcontact');
