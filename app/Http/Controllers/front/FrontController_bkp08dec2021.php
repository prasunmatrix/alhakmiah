...
use App\Models\{Brand,BrandGuideline,OurBrandSettings};
...
class FrontController extends Controller
{
    ...
    public function pages($getPages){
        ...
        $data['brandlist_mp3']=Brand::where(['status'=>'A'])->whereNull('deleted_at')->whereNotNull('mpthree')->orderBy('id','desc')->first();                            
        // echo "<pre>";
        // print_r($data['brandlist_mp3']); die;                            
        ...
        $data['position']    =  Position::where(['status'=>'A'])
                                    ->whereNull('deleted_at')
                                    ->get();*/ 
        $data['brandGuidelines']    =  BrandGuideline::where(['status'=>'A'])->whereNull('deleted_at')->orderBy('id','desc')->first();
        
        $data['OurBrandSettings']    =  OurBrandSettings::first();
        // echo "<pre>";
        // print_r($data['OurBrandSettings']); die;
