...
use App\Http\Requests\updateNewsBannerRequest;
...
class NewsBannerController extends Controller
{
    ...
    public function BannerEdit(Request $request) {
        $this->data['page_title']='News Banner Edit';
        $this->data['panel_title']='News Banner Edit';
        ...
        $this->data['details'] = NewsBanner::findOrFail($bannerId);
        $this->data['encryptCode'] = $encryptString;
        //dd($this->data['details']);
        return view('admin.news_banner.edit',$this->data); 
    }
    ...
    public function update(updateNewsBannerRequest $request){
        ...
        try
        {
        	if ($request->isMethod('POST'))
        	{
                ...
                $bannerModelObj =  NewsBanner::findOrFail($serviceId);
                ...
                if($save){
                    return redirect()->route('admin.news-banner.edit')->with('success','Banner has been updated successfully.');;
