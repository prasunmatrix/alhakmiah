...
class DashboardController extends Controller
{
    ...
    public function dashboardView()
    {
        ...
        $this->data['projects']    = Project::whereNull('deleted_at')->count();
        $this->data['service']     = Service::whereNull('deleted_at')->count();
        $this->data['cms']         = Cms::whereNull('deleted_at')->count();
        $this->data['projectList'] = Project::with('getCity')->whereNull('deleted_at')->orderBy('id', 'desc')->take(5)->get(); 
        
        $this->data['serviceList'] = Service::whereNull('deleted_at')->orderBy('id', 'desc')->take(5)->get(); 
        $this->data['cmsList']     = Cms::whereNull('deleted_at')->orderBy('id', 'desc')->take(5)->get(); 
    ...
    {
        $this->data['page_title'] = 'Control Panel | Show Profile';
        $this->data['panel_title'] = 'Show Profile';

        $this->data['user'] = User::findOrFail(Auth::guard('admin')->user()->id);
    ...
    {
        $this->data['page_title'] = "Configurations";
        $this->data['panel_title'] = "Configurations";
