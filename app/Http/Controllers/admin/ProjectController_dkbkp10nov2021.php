        ...
        try {
            ...
            if ($validator->fails()) { 
                ...
                /*if($request->file('video_thumbnail_image')) {
                    ...
                    $filesvideo=$request->file('video_thumbnail_image');
                    $fullFileName2 = time().'.'.$filesvideo->getClientOriginalExtension();
                    $destinationPath2                  = 'admin/upload/project/video_thumbnail_image';
                    $uploadResponse                   = $filesvideo->move($destinationPath2,$fullFileName2);

                    $project->video_thumbnail_image=$fullFileName2;
                }*/ 
