...
Route::group(["prefix" => "en","namespace"=>"front", 'as' => 'front.'], function() {
    ...
    Route::get('/our-achievements', 'OurAchievementsController@index');
		Route::get('/blog', 'BlogController@blogListing');
		Route::get('/blog-details/{slug}', ['as'=>'blog-details', 'uses'=>'BlogController@index']);
...
Route::group(["prefix" => "","namespace"=>"front", 'as' => 'front.'], function() {
   ...
   Route::get('/investor-relations', 'InvestorController@index_ar')->name('investor-page-ar');
    ...
    Route::get('/our-achievements', 'OurAchievementsController@index_ar');
		Route::get('/blog', 'BlogController@blogListingAr');
		Route::get('/blog-details/{slug}', ['as'=>'blog-details', 'uses'=>'BlogController@index_ar']);
...
Route::group(["prefix" => "admin","namespace"=>"admin", 'as' => 'admin.'], function() {
        ...
        Route::group(['middleware' => 'admin'], function () {
            ...
            Route::group(['prefix' => 'blog-banner', 'as' => 'blog-banner.'], function () {
              Route::any('/edit',    'BlogController@blogBannerEdit')->name('edit');
              Route::any('/update',  'BlogController@blogBannerUpdate')->name('update');
          });
            ...
            Route::group(['prefix' => 'social', 'as' => 'social.'], function () {
                ...
                Route::any('/editblogseo', 'SocialController@blogSeoEdit')->name('editblogseo');
                Route::any('/updateblogseo', 'SocialController@blogSeoupdate')->name('updateblogseo');
            ...
            Route::group(['prefix' => 'jobs', 'as' => 'jobs.'], function () {
                ...
                Route::get('/reset-jobs-status/{encryptCode}','JobsController@resetJobsStatus')->name('reset-jobs-status');
						...
						Route::group(['prefix' => 'blog', 'as' => 'blog.'], function () {
							Route::get('/blog-list', 'BlogController@blogList')->name('blog.list');
							Route::get('/blog-add', 'BlogController@blogAdd')->name('blog.add');
							Route::any('/blog-save', 'BlogController@blogSave')->name('blog.blogSave');
              Route::any('/edit/{encryptCode}', 'BlogController@blogEdit')->name('edit');
              Route::any('/update', 'BlogController@update')->name('update');
              Route::any('/blog/delete/{encryptCode}', 'BlogController@blogDelete')->name('blog.delete');
              Route::get('/reset-blog-status/{encryptCode}','BlogController@resetBlogStatus')->name('reset-blog-status');
						});
