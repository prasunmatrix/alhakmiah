                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header"><a href="{{route('admin.blog-banner.edit')}}">+ Add Blog Banner </a>
                                    <h3 class="card-title add-right">
                                        <a href="{{route('admin.blog.blog.add')}}"
                                        class="btn btn-xs create_button">+ Blog Create</a>
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.news.news.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($blogList as $data )
                                                        ...
                                                        <td>{{$data->title_ar}}</td>
                                                        <td>
                                                            @if (!empty($data->blog_small_image))
                                                                <img src="{{ asset('/assets/blog-images/small-image') }}/{{ $data->blog_small_image }}" alt="" width="150px" height="150px">
                                                                @else
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.blog.reset-blog-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.blog.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Blog Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.blog.blog.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="Blog Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $blogList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
