                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.blog-banner.update')}}" method="POST" enctype="multipart/form-data" id="edit_banner_iamge">
                            {{ csrf_field() }}
                                     ...
                                     @if (!empty($details->banner))
                                           <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                ...
                                                <img src="{{ asset('assets/cms/banner_blog/'.$details->banner.'') }}" alt=""  width="150px" >
