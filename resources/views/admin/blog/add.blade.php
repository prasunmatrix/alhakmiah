        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.blog.blog.list')}}">Blog List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.blog.blog.blogSave')}}" method="POST" enctype="multipart/form-data" id="news_add">
                            {{ csrf_field() }}
                          <div class="row">
                            <div class="card card-primary">
                                <div class="card-header">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Blog Small Image:<span class="error">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Blog Big Image:<span class="error">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label"> Blog Date: <span class="error">*</span></label>
                                        <div class="col-sm-4">
                                          <input type="date" name="blog_date" id="blog_date" class="form-control" placeholder="News Date" title="News Date">
                                        </div>
                                      </div>
