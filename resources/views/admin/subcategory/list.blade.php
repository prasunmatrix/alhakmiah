                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.subcategory.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            </div>
                                                    ...
                                                    @foreach($categoryList as $data )
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.subcategory.reset-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.subcategory.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Category Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.subcategory.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="Category Delete"><i class="fas fa-trash"></i></a>
