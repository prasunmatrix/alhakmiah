        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.subcategory.list')}}">Sub Category List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.subcategory.update')}}" method="POST" enctype="multipart/form-data" id="category_edit">
                            {{ csrf_field() }}
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                  <div class="card-header">
                                   ...
                                   <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label">Parent Category: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <select class="form-control select2 select2-danger select2bs4" name="parentcategory" id="parentcategory" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                          <option value="" @if($details->parent_id == '') selected @endif>Choose option</option>
                                              @foreach($categories as $cat)
                                                  <option value="{{$cat->id}}" @if($details->parent_id == $cat->id) selected @endif>{{$cat->name_en}} / {{$cat->name_ar}}</option>
                                              @endforeach  
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          <a class="btn btn-primary back_new" href="{{route('admin.subcategory.list')}}">Back</a>
