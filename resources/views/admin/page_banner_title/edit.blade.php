                            ...
                            <input type="hidden" name="encString" value="{{ $encryptCode }}">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12"> 
                                      ...
                                      <div class=" card card-primary">
                                        <div class="card-header">
                                          <h3 class="card-title"> Blog Page Banner Title Settings </h3>
                                        </div>
                                      </div>    
                                      <div class="col-md-12"> 
                                        <div class="form-group row">
                                          <label  class="col-sm-3 col-form-label"> Blog Title En: <span class="error">*</span></label>
                                            <div class="col-sm-9">
                                              <input type="text" name="blog_en" id="blog_en" class="form-control" value="{{ $details->blog_en}}" placeholder="Blog Title En" title="Blog Title En">
                                            </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-12"> 
                                        <div class="form-group row">
                                          <label  class="col-sm-3 col-form-label"> Blog Title Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="blog_ar" id="blog_ar" class="form-control" value="{{ $details->blog_ar}}" placeholder="Blog Title Ar" >
                                          </div>
                                        </div>
                                      </div>
