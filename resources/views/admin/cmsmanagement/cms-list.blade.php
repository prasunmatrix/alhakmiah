                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Cms
                                        Create</a>
                                    </h3>
                                </div>
                                                    ...
                                                    @foreach($cmsList as $data )
                                                        ...
                                                        <td>
                                                            @if (!empty($data->banner_image))
                                                                <img src="{{ asset('assets/cms/banner_images') }}/{{ $data->banner_image }}" alt="" width="150px">
                                                                @else
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.cms-management.reset-cms-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.cms-management.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Cms Edit"><i class="fas fa-edit"></i></a>
                                                                <a href="javascript:void(0)" data-redirect-url="{{route('admin.cms-management.cms-delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="Cms Delete"><i class="fas fa-trash"></i></a>                                 
                                                            </div>    
                                                         </td>
                                                        </tr>
                                                        @endforeach
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $cmsList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
