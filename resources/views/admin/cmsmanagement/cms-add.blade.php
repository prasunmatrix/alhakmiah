                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.cms-management.cms-save')}}" method="POST" enctype="multipart/form-data" id="create_cms">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="name_en" id="name_en" class="form-control" placeholder="Name En" title="Name En">
                                        </div>
                                      </div>
...
<div class="col-md-12">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
          <textarea class="textarea" name="json_ld" id="json_ld" placeholder="JSON-LD"
      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label"> Banner Title En: </label>
                                        <div class="col-sm-9">
                                          <input type="text" name="page_title_en" id="page_title_en" class="form-control"  placeholder="Banner Title En" title="Banner Title En">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Banner Title Ar: </label>
                                          <div class="col-sm-9">
                                            <input type="text" name="page_title_ar" id="page_title_ar" class="form-control"  placeholder="Banner Title Ar" title="Banner Title Ar">
                                          </div>
                                        </div> 
                                      ...
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Display Under Investor Relations: </label>
                                        <div class="col-sm-9">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Download Button Label En: </label>
                                        <div class="col-sm-9">
                                          <input type="text" name="brochure_label_en" id="brochure_label_en" class="form-control"  placeholder="Brochue Label En" title="Brochue Label En">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Download Button Label Ar: </label>
                                          <div class="col-sm-9">
                                            <input type="text" name="brochure_label_ar" id="brochure_label_ar" class="form-control"  placeholder="Brochure Label Ar" title="Brochure Label Ar">
                                          </div>
                                        </div>  
