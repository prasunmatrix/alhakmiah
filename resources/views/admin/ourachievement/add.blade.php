        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Our Achievement Create</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.our-achievements.ourAchievement.Save')}}" method="POST" enctype="multipart/form-data" id="achievent_add">
                            {{ csrf_field() }}
                          <div class="row">
                            <div class="card card-primary">
                                <div class="card-header">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Our Achievements Image:<span class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="file" name="image"  id="image"  class="form-control" >
                                             <span class="system required" style="color: red;">(Recommended Image Size: 1000 &times; 557)*</span>
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9"> 
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control float-right" name="year" id="date"  autocomplete="off">
                                        </div>
                                      </div>
                                    </div> 
                                    {{-- <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label"> Year: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="year" id="year" class="form-control" placeholder="Year" title="Year">
                                        </div>
                                      </div> --}}
                                      <div class="form-group row">
