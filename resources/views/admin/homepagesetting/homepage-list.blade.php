    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Home Page Setting List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Home Page Setting List</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.home-page-setting.homepage.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                                    ...
                                                    @foreach($homePageList as $data )
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.home-page-setting.reset-home-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.home-page-setting.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Home Setting Edit"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $homePageList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
