                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.service-banner.update')}}" method="POST" enctype="multipart/form-data" id="edit_service">
                            {{ csrf_field() }}
                          ...
                          <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" name="banner"  id="service_banner"  class="form-control">
