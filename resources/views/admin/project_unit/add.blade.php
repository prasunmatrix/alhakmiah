                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.unit.save')}}" method="POST" enctype="multipart/form-data" id="create_unit">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="unit_name" id="unit_name" class="form-control" placeholder="Name En" title="Name En" required>
                                        </div>
                                      </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>
                                       <div class="unit-titile">Heading</div>
                                        <div class="unit-row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="unit_name_ar" id="unit_name_ar" class="form-control" placeholder="Name Ar" title="Name Ar" required>
                                          </div>
                                      </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>
                                    		<div class="unit-titile">عنوان</div>
                                            <div class="unit-row">
                                            <div class="left">الكتلة اليسرى </div>
                                            <div class="right">الكتلة الصحيحة</div>
                                            </div>
                                            <div class="unit-row">
                                            <div class="left">الكتلة اليسرى </div>
                                            <div class="right">الكتلة الصحيحة </div>
