    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Jobs Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header"><a href="{{route('admin.jobs-banner.edit')}}">+ Add Jobs Banner</a>
                                    <h3 class="card-title add-right">
                                        <a href="{{route('admin.jobs.jobs.add')}}">+ Jobs Create</a>
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.jobs.jobs.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($jobsList as $data )
                                                        ...
                                                        <td>{{$data->title_ar}}</td>
                                                        <td>
                                                            @if (!empty($data->jobs_icon))
                                                                <img src="{{ asset('/assets/images') }}/{{ $data->jobs_icon }}" alt="" width="150px">
                                                                @else
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.jobs.reset-jobs-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.jobs.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Service Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.jobs.jobs.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="service Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $jobsList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
