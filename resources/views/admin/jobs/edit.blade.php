        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.home-page-setting.homepage.list')}}">Jobs List</a></li>
              <li class="breadcrumb-item active">Jobs Edit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.jobs.update')}}" method="POST" enctype="multipart/form-data" id="edit_job">
                            {{ csrf_field() }}
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                  <div class="card-header">
                                   ...
                                   <div class="col-md-12">
                                     @if (!empty($details->jobs_icon))
                                           <div class="form-group row">
                                              <label class="col-sm-3 col-form-label">Previous Images:</label>
                                              <div class="col-sm-9">

                                                <img src="{{ asset('assets/images/'.$details->jobs_icon.'') }}" alt="" height="100" width="30%" >
                                 ...
                                 <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Jobs Icon :</label>
                                        <div class="col-sm-9">
                                            <input type="file" name="jobs_icon"  id="jobs_icon"  class="form-control">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          <a class="btn btn-primary back_new" href="{{route('admin.jobs.jobs.list')}}">Back</a>
...
<script type="text/javascript">
  ...
  $("#jobs_icon").change(function() {
      readURL(this, 'jobsImages1',0);
  });
