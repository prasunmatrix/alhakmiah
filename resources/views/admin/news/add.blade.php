        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.cms-management.cms.list')}}">News List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.news.news.newsSave')}}" method="POST" enctype="multipart/form-data" id="news_add">
                            {{ csrf_field() }}
                          <div class="row">
                            <div class="card card-primary">
                                <div class="card-header">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">News Image:<span class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="file" name="slider_1"  id="slider_1"  class="form-control" >
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="checkbox" name="show_in_front"  id="custom7">
                                        
                                      </div>
                                    </div>

                                    <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label"> News Date: <span class="error">*</span></label>
                                        <div class="col-sm-4">
                                          <input type="date" name="news_date" id="news_date" class="form-control" placeholder="News Date" title="News Date">
                                        </div>
                                      </div>

                                   <!--  <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">News Slider-2:<span class="error">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="file" name="slider_2"  id="slider_2"  class="form-control" >
                                        </div>
                                    </div> 
                                    <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label" > Preview Slider-2 : </label>
                                      <div class="col-sm-9">
