                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.news.update')}}" method="POST" enctype="multipart/form-data" id="edit_news">
                            {{ csrf_field() }}
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                  <div class="card-header">
                                   ...
                                   <div class="col-md-12">
                                     @if (!empty($details->slider_1))
                                           <div class="form-group row">
                                              <label class="col-sm-3 col-form-label">Previous Images:</label>
                                              <div class="col-sm-9">

                                                <img src="{{ asset('assets/images/'.$details->slider_1.'') }}" alt="" height="100" width="30%" >
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> News Date: <span class="error">*</span></label>
                                          <div class="col-sm-4">
                                            <input type="date" name="news_date" id="news_date" class="form-control" value="{{ $details->news_date }}" placeholder="News Date" title="News Date">
                                          </div>
                                    </div>
