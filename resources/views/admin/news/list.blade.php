                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header"><a href="{{route('admin.news-banner.edit')}}">+ Add News Banner </a>
                                    <h3 class="card-title add-right">
                                        <a href="{{route('admin.news.news.add')}}"
                                        class="btn btn-xs create_button">+ News Create</a>
                                    </h3>
                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($newsList as $data )
                                                        ...
                                                        <td>{{$data->title_ar}}</td>
                                                        <td>
                                                            @if (!empty($data->slider_1))
                                                                <img src="{{ asset('/assets/images') }}/{{ $data->slider_1 }}" alt="" width="150px">
                                                                @else
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.news.reset-news-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.news.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Service Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.news.news.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="service Delete"><i class="fas fa-trash"></i></a>
