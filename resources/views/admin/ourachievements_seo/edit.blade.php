...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Our Achievements Page SEO Edit</h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.social.updateourachievementsseo')}}" method="POST" enctype="multipart/form-data" id="edit_title_page">
                            {{ csrf_field() }}
