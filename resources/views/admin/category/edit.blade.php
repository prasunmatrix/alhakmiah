                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.category.update')}}" method="POST" enctype="multipart/form-data" id="category_edit">
                            {{ csrf_field() }}
                                   ...
                                   <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label">Parent Category: </label>
                                        <div class="col-sm-9">
                                          ...
                                          <option value="0" @if($details->parent_id == '') selected @endif>Choose option</option>
