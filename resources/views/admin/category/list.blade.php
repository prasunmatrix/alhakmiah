                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Category Create</a>
                                        {{--<a href="{{route('admin.subcategory.add')}}"
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Sub Category Create</a>--}}
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.category.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            </div>
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($categoryList as $data )
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.category.reset-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            ...
                                                            <a href="{{route('admin.category.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Category Edit"><i class="fas fa-edit"></i></a>
                                                           
                                                            
                                                            
                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.category.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="Category Delete"><i class="fas fa-trash"></i></a>
