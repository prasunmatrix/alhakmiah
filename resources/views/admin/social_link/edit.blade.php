                                        ...
                                        <label  class="col-sm-3 col-form-label">Footer Logo: <span class="error">*</span></label>
                                          ...
                                          <div class="col-md-12"> 
                                            ...
                                            <div class="col-md-12"> 
                                              ...
                                              {{--<div class="col-md-12"> 
                                                <div class="form-group row">
                                                  <label  class="col-sm-3 col-form-label">JSON-LD: <span class="error"></span></label>
                                                  <div class="col-sm-9">
                                                    <textarea  name="json_ld" id="json_ld" placeholder="JSON-LD" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $details->json_ld }}</textarea>
                                              ...
                                              <div class="col-md-12"> 
                                                <div class="form-group row">
                                                  <label  class="col-sm-3 col-form-label">Global Site Tag: <span class="error"></span></label>
                                                  <div class="col-sm-9">
                                                    <textarea  name="global_site_tag" id="global_site_tag" placeholder="Global Site Tag" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $details->global_site_tag }}</textarea>
                                                    <span class="system required" style="color: red;">(The text box contain must have "script" tag)*</span>
                                                  </div>
                                                </div>
                                              </div>
