                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.user-management.user-editSubmit',[$encryptCode])}}" method="POST"  id="edit_User">
                                    {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                    <select name='role_id' id='role_id' class="form-control" required>
                                                            ...
                                                            <option value="{{  $row->id  }}" @if($row->id == $details->role_id ){{'selected'}} @endif>{{ $row->name }}</option>
                                                            @endforeach  
                                                    </select>
                                            </div>
                                        </div>
