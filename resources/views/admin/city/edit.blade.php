        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.country.country.list')}}">City List</a></li>
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <form action="{{route('admin.city.update')}}" method="POST" enctype="multipart/form-data" id="edit_city">
                            {{ csrf_field() }}
                          ...
                          <div style="padding: 20px 0">
                                <div class="form-group row" >
                                  ...
                                  <div class="col-sm-9">
                                  <?php $selectedvalue=$details->country_id;?>
                                  <select class="form-control" id="country_id" name="country_id" data-dropdown-css-class="select2-danger">

                                    <option value="">--Select Country--</option>
                                        @foreach ($countries as $data)
                                          <option value="{{$data->id}}" {{ $selectedvalue == $data->id ? 'selected' : '' }} >
                                            {{$data->name_en}}
                                          </option>
                                        @endforeach
                                  </select>
                                ...
                                <div class="form-group row">
                                  <label class="col-sm-3 col-form-label">State: <span class="error">*</span></label>
                                  <div class="col-sm-9">
                                   <?php $selectedvalue=$details->state_id ;?> 
                                  <select class="form-control" id="state_id" name="state_id" data-dropdown-css-class="select2-danger" >
                                    <option value="">--Select Country--</option>
                                ...
                                <div>
                                  <div class="tab-content" >
                                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                          <div class="form-group row">
                                            <label  class="col-sm-3 col-form-label"> City Name  En: <span class="error">*</span></label>
                                            <div class="col-sm-9">
                                              <input type="text" name="name_en" id="name_en" value="{{ $details->name_en }}" class="form-control div-design" placeholder="City Name  En" title="City En">
                                              </div>
                                            </div>
                                      </div>
                                      ...
                                      <div class="tab-pane" id="tabs-2" role="tabpanel">
                                          ...
                                          <div class="form-group row">
                                            <label  class="col-sm-3 col-form-label"> City Name Ar: <span class="error">*</span></label>
                                              <div class="col-sm-9">
                                                <input type="text" name="name_ar" id="name_ar" value="{{ $details->name_ar }}"class="form-control div-design" placeholder="City Name Ar" title="City Ar">
                                              </div>
                                            </div>                              
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          <a class="btn btn-primary back_new" href="{{route('admin.city.city.list')}}">Back</a>
