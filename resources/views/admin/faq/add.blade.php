                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.project.faq.save')}}" method="POST" enctype="multipart/form-data" id="create_faq">
                            {{ csrf_field() }}
                          <div class="row">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Question En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="question_en" id="question_en" class="form-control" placeholder="Question En" title="Question En">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label"> Answer En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="answer_en" id="answer_en" class="form-control" placeholder="Name En" title="Name En">
                                        </div>
                                      </div>
                                     ...
                                     <div class="col-md-12"> 
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Question Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="question_ar" id="question_ar" class="form-control" placeholder="Question Ar" title="Question Ar">
                                          </div>
                                        </div>
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Answer Ar: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="answer_ar" id="answer_ar" class="form-control" placeholder="Name En" title="Name En">
                                        </div>
                                      </div>
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control select2 select2-danger select2bs4" name="project" id="project" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                            ...
                                            @foreach($projects as $pro)
                                              <option value="{{$pro->id}}">{{$pro->name}} / {{$pro->name_ar}}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                      </div>
