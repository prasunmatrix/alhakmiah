        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit button text</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
              <form action="{{route('admin.investor-relations.buttoneditupdate')}}" method="POST" enctype="multipart/form-data" id="button_investor">
                            {{ csrf_field() }}
                                  ...
                                  <h3 class="card-title">English</h3>
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> View annual reports En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="annual_en" id="annual_en" class="form-control" value="{{$details->annual_en}}" placeholder="View annual reports En" title="View annual reports En">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> View financial results En: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                           <input type="text" name="financial_en" id="financial_en" class="form-control" value="{{$details->financial_en}}" placeholder="View financial results En" title="View financial results En">
...
<div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Profit presentation En: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                           <input type="text" name="Profit_en" id="Profit_en" class="form-control" value="{{$details->profit_en}}" placeholder="Profit presentation En" title="Profit presentation En">
...
<div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> View the Basel reports En: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                           <input type="text" name="Basel_en" id="Basel_en" class="form-control" value="{{$details->base_en}}" placeholder="View the Basel reports En" title="View the Basel reports En">
                                    ...
                                    <div class="col-md-12"> 
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" name="annual_ar" id="annual_ar" class="form-control" value="{{$details->annual_ar}}" placeholder="Title Ar" title="Title Ar">
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
<input type="text" name="financial_ar" id="financial_ar" class="form-control" value="{{$details->financial_ar}}" placeholder="Title Ar" title="Title Ar">
 ...
 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" name="Profit_ar" id="Profit_ar" class="form-control" value="{{$details->profit_ar}}" placeholder="Profit presentation Ar" title="Title Ar">
                                        </div>
                                      </div>
 <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">View the Basel reports Ar: <span class="error">*</span> </label>
                                        <div class="col-sm-9">
                                        <input type="text" name="Basel_ar" id="Basel_ar" class="form-control" value="{{$details->base_ar}}" placeholder="View the Basel reports ar" title="Title Ar">
                                        </div>
                                      </div>
                                  </div>
