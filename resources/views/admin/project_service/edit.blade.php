                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.projectservices.update')}}" method="POST" enctype="multipart/form-data" id="edit_project_service">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="service_name" id="service_name" class="form-control" placeholder="Name En" title="Name En" value="{{$serviceDetail->service_name}}" required>
                                        </div>
                                      </div> 
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="service_name_ar" id="service_name_ar" class="form-control" placeholder="Name Ar" title="Name Ar" value="{{$serviceDetail->service_name_ar}}" required>
                                          </div>
                                      </div>
                                  ...
                                  <div class="col-md-12">
                                           ...
                                           <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                                ...
                                                                <img src="{{ asset('/admin/upload/project_services/thumbnail') }}/{{ $serviceDetail->service_image }}" alt="">
                                                <input type="hidden" name="old_service_image"  id="old_service_image"  class="form-control" value="{{ $serviceDetail->service_image }}" required>
                                              </div>
                                          </div> 
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          ...
                                          <input type="hidden" name="project_service_id" value="{{ $serviceDetail->id }}">
