                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Banner Create</a>
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.banner.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($bannerList as $data )
                                                        ...
                                                        <td>@if($data->type=="image")
                                                                @if (!empty($data->banner))
                                                                <img src="{{ asset('/assets/cms/banner_images') }}/{{ $data->banner }}" alt="" width="150px">
                                                                @else
                                                        ...
                                                        @else
                                                            <video width="320" height="240" controls>
                                                                <source src="{{URL::asset("/assets/cms/banner_images/$data->banner")}}" type="video/mp4">
                                                     ...
                                                     <td>{{$data->type}}</td>
                                                        ...
                                                        <td class="">
                                                            @if($data->status == '1')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.banner.reset-banner-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.banner.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Service Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.banner.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="service Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $bannerList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
