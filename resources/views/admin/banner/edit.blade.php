        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.home-page-setting.homepage.list')}}">Banner List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.banner.update')}}" method="POST" enctype="multipart/form-data" id="edit_banner">
                            {{ csrf_field() }}
                                  ...
                                  <div class="col-md-12">   
                                    <div class="form-group row">
                                      ...
                                      <select class="form-control select2 select2-danger select2bs4" name="type" id="type"  data-dropdown-css-class="select2-danger" style="width: 100%;">
                                        ...
                                        <option value="image" {{ $details->type == 'image' ? 'selected' : '' }}>Image</option>
                                        <option value="video" {{ $details->type == 'video' ? 'selected' : '' }} >Video</option>
                                      </select>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                          <div class="row cmsImages" >
                                              ...
                                              <div id="{{ 'imageDiv'.$details->id.'' }}" class="col-sm-3">
                                                <img src="{{ asset('/assets/cms/banner_images/'.$details->banner.'') }}" alt="" height="100" width="100%" id="banner">
                                              </div>
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                            <video width="320" height="240" controls>
                                              <source src="{{URL::asset("/assets/cms/banner_images/$details->banner")}}" type="video/mp4">
