                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <form action="{{route('admin.country.update')}}" method="POST" enctype="multipart/form-data" id="create_coutry">
                            {{ csrf_field() }}
                              ...
                              <div class="tab-content" style="padding: 20px 0">
                                 <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                       <div class="form-group row">
                                         ...
                                         <div class="col-sm-9">
                                           <input type="text" name="name_en" id="name_en"  class="form-control div-design" value="{{ $details->name_en }}" placeholder="Country Name En " title="Country Name En">
                                           </div>
                                         </div>
                                   </div>
                                   ...
                                   <div class="tab-pane" id="tabs-2" role="tabpanel">
                                       <div class="form-group row">
                                         <label  class="col-sm-3 col-form-label"> Contry Name Ar: <span class="error">*</span></label>
                                           <div class="col-sm-9">
                                             <input type="text" name="name_ar" id="name_ar" class="form-control div-design" value="{{ $details->name_ar }}" placeholder="Contry Name Ar " title="Contry Name Ar">
                                           </div>
                                         </div>                              
                                     </div>
                                   </div>
