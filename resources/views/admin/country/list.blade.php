                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <a href="{{route('admin.country.country.add')}}"
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Country
                                        Create</a> 
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.country.country.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                                    ...
                                                    @foreach($countryList as $data )
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.country.reset-country-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.country.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Country Edit"><i class="fas fa-edit"></i></a>

                                                                <a href="javascript:void(0)" data-redirect-url="{{route('admin.country.country.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="faq Delete"><i class="fas fa-trash"></i></a>                                 
                                                            </div>    
                                                         </td>
                                                        </tr>
                                                        @endforeach
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $countryList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
