        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tv Interviews Create</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.tv-channels.tvChannelSave')}}" method="POST" enctype="multipart/form-data" id="news_add">
                            {{ csrf_field() }}
                          <div class="row">
                            <div class="card card-primary">
                                <div class="card-header">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Interviews Date: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="interviews_date" id="interviews_date" class="form-control" placeholder="Interviews Date" title="Interviews Date">
                                        </div>
                                      </div>
