...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Home Page Gallery</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="{{route('admin.home-page-setting.homepage.list')}}">Home Page Gallery List</a></li>
              <li class="breadcrumb-item active">Home Page Gallery Edit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.home-page-gallery.update')}}" method="POST" enctype="multipart/form-data" id="edit_galery">
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                          <div class="row homeImages" >
                                            @foreach ($details->Gallery as $data )
                                              @php $chkd = ''; if ($data->is_checked == 'Y') $chkd = 'checked'; @endphp
                                              <div id="{{ 'imageDiv'.$data->id.'' }}" class="col-sm-3">
                                                <img src="{{ asset('assets/cms/gallery/'.$data->image.'') }}" alt="" height="100" width="100%" id="brand_icon">
                ...
                if (trueResponse) {
                  ...
                  if(imageDivId != 0){
                    ...
                    $.ajax({
                        ...
                        contentType: false,
                        processData: false, 
                        url: "{{ route('admin.home-page-gallery.gallery-image-delete') }}",
                        data: fdata,
