        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.position.list')}}">Position List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.position.update')}}" method="POST" enctype="multipart/form-data" id="category_edit">
                            {{ csrf_field() }}
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Title En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="name_en" id="name_en" class="form-control" value="{{ $details->name_en }}" placeholder="Title En" title="Title En">
                                        </div>
                                      </div>
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Designation En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="designation_en" id="designation_en" class="form-control" value="{{ $details->designation_en }}" placeholder="Designation En" title="Designation En">
                                        </div>
                                      </div>
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Description En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="description_en" id="description_en" class="form-control" value="{{ $details->description_en }}" placeholder="Description En" title="Description En">
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-md-12"> 
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Title Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="name_ar" id="name_ar" class="form-control" value="{{ $details->name_ar }}" placeholder="Title Ar" title="Title Ar">
                                          </div>
                                        </div>
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Designation Ar: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="designation_ar" id="designation_ar" class="form-control" value="{{ $details->designation_ar }}" placeholder="Designation Ar" title="Designation Ar">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Description Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="description_ar" id="description_ar" class="form-control" value="{{ $details->description_ar }}" placeholder="Description Ar" title="Description Ar">
                                          </div>
                                        </div>
                                   ...
                                   <div class="form-group row">
                                      <label  class="col-sm-3 col-form-label">Category: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          ...
                                          <option value="" @if($details->cat_id == '') selected @endif>Choose option</option>
                                              @foreach($categories as $cat)
                                                  <option value="{{$cat->id}}" @if($details->cat_id == $cat->id) selected @endif>{{$cat->name_en}} / {{$cat->name_ar}}</option>
                                              @endforeach  
                                      ...
                                      <label  class="col-sm-3 col-form-label">Sub Category: </label>
                                        <div class="col-sm-9">
                                          ...
                                          <option value="" @if($details->subcat_id == '') selected @endif>Choose option</option>
                                              @foreach ($subcategory as $value)
                                                <option value="{{ $value->id }}"{{ ( $details->subcat_id == $value->id ) ? ' selected' : '' }}>{{ $value->name_en }}</option>
                                              @endforeach
                                      ...
                                      @if (!empty($details->image))
                                           <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                <img src="{{ asset('/admin/upload/ceo_image') }}/{{$details->image}}" alt="" height="100" width="30%">
                                              </div>
                                          </div> 
                                       @endif
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        $.each(data.record, function(key, value) {
                            $('select[name="subcategory"]').append('<option value="'+ value.id +'">'+ value.name_en +'/'+value.name_ar +'</option>');
                        });
