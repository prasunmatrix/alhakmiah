    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Position Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Position Create</a>
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.position.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($positionList as $data )
                                                        ...
                                                        <td>{{$data->designation_ar}}</td>
                                                        
                                                        <td>
                                                            @if (!empty($data->image))
                                                                <img src="{{ asset('/admin/upload/ceo_image') }}/{{ $data->image }}" alt="" width="150px">
                                                                @else
                                                                <img src="{{ asset('/admin/upload/common/no-image-found.jpg') }}" alt=""  width="80px" >
                                                                @endif
                                                        </td>
                                                        <td>{{$data->getCategory->name_en}} / {{$data->getCategory->name_ar}}</td>
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.position.reset-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.position.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Position Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.position.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="Position Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $positionList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
