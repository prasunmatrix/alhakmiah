        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.home-page-setting.homepage.list')}}">Service List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.service.update')}}" method="POST" enctype="multipart/form-data" id="edit_service">
                            {{ csrf_field() }}
                                ...
                                <div class="card-header">
                                  <h3 class="card-title">English</h3>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                      <textarea class="textarea" name="short_description_ar" id="short_description_ar" placeholder="Short Description En"
                                  ...
                                  @if (!empty($details->image))
                                           <div class="form-group row">
                                              <label class="col-sm-3 col-form-label">Previous Image:</label>
                                              <div class="col-sm-9">

                                                <img src="{{ asset('assets/images/'.$details->image.'') }}" alt=""  width="150px" >
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          <a class="btn btn-primary back_new" href="{{route('admin.service.service.list')}}">Back</a>
