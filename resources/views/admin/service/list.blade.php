                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header"><a href="{{route('admin.service-banner.edit')}}">+ Add Service Banner</a>
                                    <h3 class="card-title add-right">
                                        <a href="{{route('admin.service.service.add')}}"
                                        class="btn btn-xs create_button">+ Service Create</a>
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.service.service.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                class="table table-bordered table-hover dataTable dtr-inline"
                                                    ...
                                                    @foreach($serviceList as $data )
                                                        ...
                                                        <td>
                                                        @if (!empty($data->image))
                                                            <img src="{{ asset('/assets/images') }}/{{ $data->image }}" alt="" width="150px">
                                                            @else
                                                            <img src="{{ asset('/admin/upload/common/no-image-found.jpg') }}" alt=""  width="150px" >
                                                        @endif
                                                        </td>
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.service.reset-service-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.service.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Service Edit"><i class="fas fa-edit"></i></a>

                                                                 <a href="javascript:void(0)" data-redirect-url="{{route('admin.service.service.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="service Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $serviceList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
