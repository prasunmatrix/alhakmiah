                        ...
                        <!-- /.card-header -->
                              <div class="card-body">
                                    @if(count($errors) > 0)
                                        ...
                                        @endif            
                                  <form action="{{route('admin.roles.update',[$role->id])}}" method="POST"  id="edit_role">
                                        {{ csrf_field() }}
                                        @method('PUT')
                                      <div class="row">
                                          <div class="col-md-10">
                                                  ...
                                                  <label  class="col-sm-2 col-form-label">Role Name : <span class="error">*</span></label>
                                                    <div class="col-sm-10">
                                                      <input type="text" name="name" id="name" class="form-control" value="{{$role->name}}" placeholder="Role Name" title="Role Name">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Role Description : <span class="error">*</span></label>
                                                      <div class="col-sm-10">
                                                        ...
                                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$role->description}}</textarea>                                                
                                                      </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="checkbox">
                                                                    <label><input name="permissions[]" {{ (in_array($permission->id,$role->permissionsIdsArray()))?'checked':'' }} type="checkbox" value="{{ $permission->id}}">&nbsp; &nbsp;{{ $permission->name }}</label>
                                                                </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
