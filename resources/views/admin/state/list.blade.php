                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <!-- {{$panel_title}} -->
                                        <a href="{{route('admin.state.state.add')}}"
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ State
                                        Create</a> 
                                    </h3>
                                </div>
                                    ...
                                    <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <a href="{{ route('admin.state.state.list') }}" class="btn btn-sm btn-danger">Reset</a>
                                                    ...
                                                    @foreach($stateList as $data )
                                                        ...
                                                        <td class="">
                                                            @if($data->status == 'A')
                                                                <button type="button" id="status_{{$data->id}}" data-rowid="{{$data->id}}" class="btn btn-block btn-success btn-xs changeStatus"
                                                                 data-redirect-url="{{route('admin.state.reset-state-status',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                        ...
                                                        <td class=""> 
                                                            <div class="btn-group btn-group-sm">
                                                                ...
                                                                <a href="{{route('admin.state.edit',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Country Edit"><i class="fas fa-edit"></i></a>

                                                                <a href="javascript:void(0)" data-redirect-url="{{route('admin.state.state.delete',['encryptCode'=>encrypt($data->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title="faq Delete"><i class="fas fa-trash"></i></a>                                 
                                                            </div>    
                                                         </td>
                                                        </tr>
                                                        @endforeach
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $stateList->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
