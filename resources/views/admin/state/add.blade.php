        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.state.state.list')}}">State List</a></li>
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.state.state.stateSave')}}" method="POST" enctype="multipart/form-data" id="create_cms">
                            {{ csrf_field() }}
                                ...
                                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> State Name  En: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="name_en" id="name_en" class="form-control div-design" placeholder="State Name" title="State En">
                                          </div>
                                        </div>
                                  </div>
                                  ...
                                  <div class="tab-pane" id="tabs-2" role="tabpanel">
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> State Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="name_ar" id="name_ar" class="form-control div-design" placeholder="State Name" title="State Ar" >
                                          </div>
                                        </div>                              
