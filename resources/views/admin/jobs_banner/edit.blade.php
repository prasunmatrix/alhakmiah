        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.service.service.list')}}">Service List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.jobs-banner.update')}}" method="POST" enctype="multipart/form-data" id="edit_service">
                            {{ csrf_field() }}
                          ...
                          <div class="row">
                                  ...
                                  <div class="col-md-12">
                                     ...
                                     @if (!empty($details->banner))
                                           <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                ...
                                                <img src="{{ asset('assets/cms/banner_images/'.$details->banner.'') }}" alt=""  width="150px" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" name="banner"  id="jobs_banner"  class="form-control">
...
function readURL(input, place, counter) {
  ...
  $("#jobs_banner").change(function() {
      readURL(this, 'jobsImages',0);
  });
