                          ...
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" name="brochure"  id="brochure"  class="form-control" accept="application/pdf" required>
                              ...
                              <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Brochure:</label>
                                        <div class="col-sm-9">
                                            <input type="file" name="brochure_ar"  id="brochure_ar"  class="form-control"  accept="application/pdf" required>
                                            <span class="system required" style="color: red;">(Only pdf file allowed.)*
                                        </div>
                                      </div> 
