                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.type.update')}}" method="POST" enctype="multipart/form-data" id="edit_project_type">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="type" id="type" class="form-control" placeholder="Name En" title="Name En" value="{{$typeDetail->type}}" required>
                                        </div>
                                      </div> 
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="type_ar" id="type_ar" class="form-control" placeholder="Name Ar" title="Name Ar" value="{{$typeDetail->type_ar}}" required>
                                          </div>
                                      </div>
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          ...
                                          <input type="hidden" name="project_type_id" value="{{ $typeDetail->id }}">
