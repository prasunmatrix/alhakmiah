        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.press-kits.list')}}">Press Kit List</a></li>
              <li class="breadcrumb-item active">Press Kit Create</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.press-kits.pressKitSave')}}" method="POST" enctype="multipart/form-data" id="presskit_add">
                            {{ csrf_field() }}
                          <div class="row">
                            <div class="card card-primary">
                                <div class="card-header">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Format En: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="format_en" id="format_en" class="form-control" placeholder="Format En" title="Format En">
                                          </div>
                                        </div>
                                    ...
                                    <div class="col-md-12"> 
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Format Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="format_ar" id="format_ar" class="form-control" placeholder="Format Ar" title="Format Ar">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="card card-primary">
