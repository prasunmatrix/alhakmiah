                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.projectnear.save')}}" method="POST" enctype="multipart/form-data" id="create_project_near">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="near_name" id="near_name" class="form-control" placeholder="Name En" title="Name En" >
                                        </div>
                                      </div> 
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="near_name_ar" id="near_name_ar" class="form-control" placeholder="Name Ar" title="Name Ar" >
                                          </div>
                                      </div>
                                ...
                                <div class="card card-primary">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" name="near_image"  id="near_image"  class="form-control" required>
