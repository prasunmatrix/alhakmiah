        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.status.index')}}">Project Status List</a></li>
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.status.update')}}" method="POST" enctype="multipart/form-data" id="edit_project_status">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="status" id="status" class="form-control" placeholder="Name En" title="Name En" value="{{$statusDetail->status}}" required>
                                        </div>
                                      </div> 
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="status_ar" id="status_ar" class="form-control" placeholder="Name Ar" title="Name Ar" value="{{$statusDetail->status_ar}}" required>
                                          </div>
                                      </div>
                                    ...
                                    <div class="card-footer">
                                      <div class="">
                                          <a class="btn btn-primary back_new" href="{{route('admin.status.index')}}">Back</a>
                                          <input type="hidden" name="project_status_id" value="{{ $statusDetail->id }}">
