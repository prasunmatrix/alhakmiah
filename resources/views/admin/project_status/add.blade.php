...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Project Status Management</h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0)
                            ...
                            @endif
                      <form action="{{route('admin.status.save')}}" method="POST" enctype="multipart/form-data" id="create_project_status">
                            {{ csrf_field() }}
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                      ...
                                      <label  class="col-sm-3 col-form-label"> Name En: <span class="error">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="text" name="status" id="status" class="form-control" placeholder="Name En" title="Name En" required>
                                        </div>
                                      </div> 
                              ...
                              <div class="col-md-12">
                                      ...
                                      <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label"> Name Ar: <span class="error">*</span></label>
                                          <div class="col-sm-9">
                                            <input type="text" name="status_ar" id="status_ar" class="form-control" placeholder="Name Ar" title="Name Ar" required>
                                          </div>
                                      </div>
...
$("#create_project_status").validate({
    rules: {
      status: {
            required: true,  
        },
