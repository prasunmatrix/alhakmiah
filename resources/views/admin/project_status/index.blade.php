                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                                <div class="card-header">
                                    <!-- {{ $panel_title }} -->
                                    <h3 class="card-title">
                                        <a href="{{route('admin.status.add')}}"
                                        class="btn btn-xs create_button" style="margin-left: 810px;">+ Project Status
                                        Create</a>
                                    </h3>
                                </div>
                            ...
                            <div class="card-body">
                                   ...
                                   <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="search" name="q" class="form-control" id="" placeholder="Search by Status" value="{{ $_GET['q'] ?? '' }}">
                                            </div>
                                            
                                            <div class="col-sm-3">
                                                <button type="submit" class="btn btn-info btn-sm">Search</button>
                                                <a href="{{ route('admin.status.index') }}" class="btn btn-sm btn-danger">Reset</a>
                                                        ...
                                                        @foreach($status as $st )
                                                            ...
                                                            <td class="">
                                                                @if($st->status_flag == '1')
                                                                 ...
                                                                 data-redirect-url="{{route('admin.status.reset-status',['encryptCode'=>encrypt($st->id, Config::get('Constant.ENC_KEY'))])}}">
                                                                Active</button>
                                                            @else
                                                            ...
                                                            <td class=""> 
                                                                <div class="btn-group btn-group-sm">
                                                                    ...
                                                                    <a href="{{route('admin.status.edit',['encryptCode'=>encrypt($st->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-info" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                                                    <a href="javascript:void(0)" data-redirect-url="{{route('admin.status.status-delete',['encryptCode'=>encrypt($st->id, Config::get('Constant.ENC_KEY'))])}}" class="btn btn-danger delete-alert" id="button" data-toggle="tooltip" title=" Delete"><i class="fas fa-trash"></i></a>
                                ...
                                <div class="card-footer clearfix">
                                    <div class="paginationDiv ">
                                        <div class="float-right">
                                            {{ $status->appends(\Request::except('page'))->render() }}
                                        </div>
                                    </div>
                                </div>
