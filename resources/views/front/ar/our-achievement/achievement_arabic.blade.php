  ...
  <section class="hero-banner alt inner_banner" data-aos="fade-up" data-aos-delay="1000">
    ...
    <div class="container">
      <div class="inner_banner_txt">
        <h2>{{$ourAchievementsHeading['our_achievement_heading_ar']}}</h2>
      </div>
    </div>
  </section>
  ...
  <section class="achievements-wrapper">
    <div class="container">
      <div class="row">
          <div class="col-lg-12">
              <h2>إنجازاتنا </h2>
              @if (!empty($ourAchievementsHeading->ach_description_ar))
              <p class="achiev-description">{{$ourAchievementsHeading['ach_description_ar']}}</p>
              @endif
                <?php
                ...
                <div class="achievements-row">
                  <div class="year" data-aos="fade-up">
                      ...
                      <p><?php echo $data->description_ar; ?></p>
                  </div>
