...
<tr>
  <td style="background:rgb(223, 223, 223); border:1px solid #ececec;  margin:0; padding:40px; color:#000; font-family:Arial, Helvetica, sans-serif;">
    <h2 style="display:block;margin:0 auto 20px;padding:0;font-family:'Lato', Arial, sans-serif;font-size:24px;font-weight:700;font-style:normal;line-height:26px;color:#292929;text-decoration:none;text-align: center;">تطبيق الوظائف</h2>
    <p style="font-size: 14px; line-height: 26px; font-weight: 400;">
        <strong>مرحبا الادارية</strong>
    </p>
    <p style="font-size: 14px; line-height: 26px; font-weight: 400;">
        شخص ما يريد تطبيق الوظائف. فيما يلي تفاصيل المستخدم:
    </p>
    <p style="font-size: 14px; line-height: 26px; font-weight: 400;">
