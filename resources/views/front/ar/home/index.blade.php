    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          ...
          <p>{!! $homeProject->short_description_ar !!}</p>
          <a class="site-link" href="{{route('projectdetail.detail',[$homeProject['slug_name']])}}">{{$homePageSetting->feature_project_button_text_ar}}</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="news-slide">  
            <div class="owl-carousel owl-theme" id="newsslider">
                ...
                <div class="box">
                  ...
                  <a class="site-link gradient" href="{{ url('/') }}/news-details/{{ $data['slug_name'] }}">اقرأ أكثر</a>
                  </div>
                </div>
                @endforeach
            </div>
