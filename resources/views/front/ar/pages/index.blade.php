          ...
          <div class="brand-btn">
            <div class="top-btn">
              ...
              @endif    
                ...
                <div class="txt">{{ $OurBrandSettings->download_button_title1_ar}}  </div>
                <div class="icon2"><img src="{{ asset('/front/ar') }}/assets/images/icon-music.png" alt=""></div>
              </a>
              @if(!empty($brandlist_mp3))
              <a href="javascript:vooid(0);" data-fancybox="s" data-type="video" data-src="{{ asset('assets/brand-mpthree/'.$brandlist_mp3->mpthree) }}" class="btn-download1">
              @else
              <a href="javascript:vooid(0);"  class="btn-download1">
              @endif    
                <div class="icon1">
                  @if(!empty($brandlist_mp3))
                    <img src="{{ asset('assets/brand-images/'.$brandlist_mp3->press_image) }}" alt="">
                  @else
                    <img src="{{ asset('/front/ar') }}/assets/images/icon-music.png" alt="">
                  @endif
                </div>
                <div class="txt">{{ $OurBrandSettings->mussic_button_title_ar}}  </div>
                <div class="icon2"><img src="{{ asset('/front/ar') }}/assets/images/icon-play.png" alt=""></div>
              </a>               
            </div>
            <div class="bottom-btn">
              ...
              @else
              <a href="javascript:vooid(0);"  class="btn-download2">
              @endif    
                <div class="icon1"><img src="{{ asset('/front/ar') }}/assets/images/icon-download.png" alt=""></div>
                <div class="txt">{{ $OurBrandSettings->download_button_title2_ar}}  </div>
