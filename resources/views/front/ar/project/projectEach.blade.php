            ...
            <div class="col-lg-8 col-md-6">
              <form class="al-hakiam_form" action="{{route('projectcontact.savecontact')}}" method="POST">
                ...
                <div class="input-group">
                  <!-- <select name="salutation" id="salutation" class="form-control col-md-3 salutation">
                  ...
                  <input type="text" class="form-control col-md-6 salutation" placeholder="الاسم" name="first_name">
                  <input type="text" class="form-control col-md-6 salutation_reverse" placeholder="العائلة" name="last_name">

                  <!-- <input type="text" class="form-control salutation_reverse" placeholder="الاسم" name="fullname"> -->
                </div><br/>
                <div class="form-group">
