...
@section('page-content')
  ...
  <form action="{{route('ar.projectlist.index')}}" method="GET" id="filter_project">
    ...
    <div class="container">
      <div class="select-group-main project">
        ...
        <div class="btns">
          ...
          <a href="{{route('ar.projectlist.index')}}" class="btn alt">إعادة التعيين  </a>
        </div>
      </div>
    </div>
    </form>
        ...
        @foreach($projects as $project)
          <div class="list-item">
            ...
            <div class="txt">
              ...
              <a href="{{route('ar.projectdetail.detail',[$project->slug_name])}}" class="read-more">اكتشف المزيد</a>
            </div>
          </div>
