...
<section class="investor_banner" data-aos="fade-up" data-aos-delay="300">
    ...
    <div class="container">
       <div class="inner_banner_txt">
        <h2 data-aos="fade-up" data-aos-delay="300">{{$pageTite->media_center_ar}}  </h2>
       </div>
    </div>
 </section>
     ...
     <div class="section04_tab-block">
       ...
       <div class="tab-content al-hakiam_tabContent" id="pills-tabContent">
         <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <section class="news-wrapper">
               ...
               <div class="news-list">
                  ...
                  <div class="txt">
                     <a  href="{{ url('/') }}/news-details/{{ $news['slug_name'] }}"><h2>{{ $news->title_ar }}</h2></a>
                     <p class="date">{{\Carbon::parse($news->news_date)->format('d-m-Y')  }}</p>
                     <p>{!! $news->short_description_ar !!}</p>
                     <a href="{{ url('/') }}/news-details/{{ $news['slug_name'] }}" class="read-more">اقرأ أكثر</a> 
                  </div>            
               </div>
               @endforeach
            </section>
         ...
         <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <section class="news-wrapper">
               ...
               <div class="news-list">
                  ...
                  <div class="txt">
                     <h2>{{ $mediaNews->title_ar }}</h2>
                     <p class="date">{{$mediaNews->interviews_date}}</p>
                     <p>{{ $mediaNews->description_ar }}</p>
         ...
         <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            ...
            <h2 class="press-kit-heading">{{$mediatab->press_kit_heading_ar}}</h2>
               <div class="container">
                 <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="owl-carousel owl-theme" id="mediaslider">
                      @foreach($pressKits as $pressKit)
                       <div class="box">
                         <img src="{{ asset('assets/press-kit-images/'.$pressKit->press_image) }}" alt="">
                         <div> {{ $pressKit->format_ar }}</div>
                         <a href="{{ asset('assets/press-kit-images/'.$pressKit->press_image) }}" class="investor_btn" target="_blank  n" download>تحميل</a>
                       </div>
                       @endforeach
                     </div>
                 </div>
             ...
             <div class="col-lg-12">
               <div class="guideline">
                 <h2>إرشادات العلامة التجارية</h2>
                 ...
                 @foreach ($brandGuidelines as $brandGuideline)
                       <div class="col-lg-3">
                          ...
                          <a href="{{ asset('assets/brand-guidelines-pdf/'.$brandGuideline->pdf_upload) }}" class="btn-downlaod" target="_blank  n" download>تحميل</a>
                       </div>
                       {{--<div class="col-lg-3">
                          <div class="pic"><img src="{{ asset('/front/en/assets/images/mp3_thambnail_img.jpg')}}" alt=""></div>
                          <a href="{{ asset('assets/media_mp3_upload/'.$brandGuideline->media.'') }}" class="btn-downlaod" target="_blank  n" download>تحميل</a>
                       </div>--}}
                   @endforeach
                 </div>
               </div>
