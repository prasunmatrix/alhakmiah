    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="brand-btn">
            <div class="top-btn">
                @if(!empty($brandlist_mp3))
                <a href="javascript:void(0)" data-fancybox="s" data-type="video" data-src="{{ asset('assets/brand-mpthree/'.$brandlist_mp3->mpthree) }}" class="btn-download1">
                @else
                <a href="javascript:void(0)"  class="btn-download1">
                @endif    
                  <div class="icon2">
                    @if(!empty($brandlist_mp3))
                      <img src="{{ asset('assets/brand-images/'.$brandlist_mp3->press_image) }}" alt="">
                    @else
                      <img src="{{ asset('/front/en') }}/assets/images/icon-music.png" alt="">
                    @endif    
                  </div>
                  <div class="txt">{{ $OurBrandSettings->mussic_button_title_en}}</div>
                  <div class="icon1"><img src="{{ asset('/front/en') }}/assets/images/icon-play.png" alt=""></div>
                </a>
                @if(!empty($brandlist_mp3))
                <a href="{{ asset('assets/brand-brochure/'.$brandlist_mp3->brochure) }}" target="_blank" download class="btn-download1">
                @else
                <a href="javascript:void(0);"  class="btn-download1">
                @endif    
                  <div class="icon2"><img src="{{ asset('/front/en') }}/assets/images/icon-music.png" alt=""></div>                
                  <div class="txt">{{ $OurBrandSettings->download_button_title1_en}}</div>
                  <div class="icon1"><img src="{{ asset('/front/en') }}/assets/images/icon-download.png" alt=""></div>
                </a>                             
            </div>  
            <div class="bottom-btn">
              @if(!empty($brandGuidelines))
              <a href="{{ asset('assets/brand-guidelines-pdf/'.$brandGuidelines->pdf_upload) }}" target="_blank" download class="btn-download2">
              @else
              <a href="javascript:void(0);"  class="btn-download2">
              @endif    
                <div class="icon2"><img src="{{ asset('/front/en') }}/assets/images/logo-white.png" alt=""></div>
                <div class="txt">{{ $OurBrandSettings->download_button_title2_en}}</div>
                <div class="icon1"><img src="{{ asset('/front/en') }}/assets/images/icon-download.png" alt=""></div>               
              </a>
            </div>
          </div>
