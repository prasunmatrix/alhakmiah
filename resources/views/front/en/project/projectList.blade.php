...
@section('page-content')
  ...
  <form action="{{route('en.projectlist.index')}}" method="GET" id="filter_project">
    ...
    <div class="container">
      <div class="select-group-main project">
        ...
        <div class="btns">
          ...
          <a href="{{route('en.projectlist.index')}}" class="btn alt">Reassignment</a>
        ...
        @foreach($projects as $project)
            <div class="list-item">
              ...
              <div class="txt">
                ...
                <a href="{{route('en.projectdetail.detail',[$project->slug_name])}}" class="read-more">Read More</a>
              </div>
            </div>
            @endforeach
