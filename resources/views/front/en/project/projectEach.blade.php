    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-6">
              <form class="al-hakiam_form" action="{{route('en.projectcontact.savecontact')}}" method="POST">
                {{ csrf_field() }}
                <input type="hidden" name="slug" value="{{$slug}}">
                <input type="hidden" name="project_name" value="{{$projectDetail->name}}">
                <div class="input-group">
                  <!-- <select name="salutation" id="salutation" class="form-control col-md-2">
                  <option value="Mr.">Mr.</option>
                  <option value="Ms.">Ms.</option>
                  </select> -->
                  <input type="text" class="form-control col-md-6" placeholder="First Name" name="first_name">
                  <input type="text" class="form-control col-md-6" placeholder="Last Name" name="last_name">
                </div><br/>
